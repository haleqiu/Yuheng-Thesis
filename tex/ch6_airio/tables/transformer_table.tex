\begin{table}[h]
    \caption{Comparison of Transformer-based methods on EuRoC dataset and BlackBIrd dataset. Evaluation metric: ATE (Unit: \meter) and RTE (Unit: \meter)}
    \label{tab:airio:transformer_ablation}
    \centering
\resizebox{0.6\linewidth}{!}{
    \begin{tabular}{C{2cm}|C{1.2cm}C{1.2cm}C{1.2cm}C{1.2cm}C{1.2cm}C{1.2cm}C{1.2cm}C{1.2cm}}
        \toprule
        \multirow{2}{*}
        {\textbf{Seq.}}&  \multicolumn{2}{c}{\multirow{2}{*}{\shortstack{\textbf{Global-Frame} \\ \textbf{with Transformer}}}} &  \multicolumn{2}{c}{\multirow{2}{*}{\shortstack{\textbf{Body-Frame} \\ \textbf{with Transformer}}}} &  \multicolumn{2}{c}{\multirow{2}{*}{\shortstack{\textbf{AirIO} \\ \textbf{with Transformer}}}} &  \multicolumn{2}{c}{\multirow{2}{*}{\textbf{AirIO Net}}}\\ 
        & & & & & &&&\\
