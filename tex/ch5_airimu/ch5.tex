...
\fancyhead[LO]{\makebox[\textwidth][r]{Chapter 5. AirIMU}}
...
\begin{figure*}[!t]
	\centering
    \includegraphics[width=1\linewidth]{tex/ch5_airimu/figs/Figure1.pdf}
    \caption{
...
\begin{figure}[!t]
	\centering
    \includegraphics[width=0.6\linewidth]{tex/ch5_airimu/figs/imudevice.pdf}
    \caption{
...
\begin{figure}[!t]
	\centering
    \includegraphics[width=0.6\linewidth]{tex/ch5_airimu/figs/Figure2.pdf}
    \caption{
...
\begin{equation}
    ...
    \end{split}
\end{equation}
where ${\Delta}R_{ij}$, ${\Delta}v_{ij}$ and ${\Delta}p_{ij}$ denote the increments of rotation, velocity and position from frame $i$ to frame $j$ respectively.
...
\begin{figure}[!t]
	\centering
    \includegraphics[width=0.5\linewidth]{tex/ch5_airimu/figs/accelerate.pdf}
    \caption{
...
To accelerate the integration, we design a parallel scan algorithm as shown in \fref{Fig:Tree}, where each node represents an element in $SO3$.
...
\begin{figure}[t]
	\centering 
    \includegraphics[width=0.5\linewidth]{tex/ch5_airimu/figs/FigurePGO.drawio.pdf}
...
\begin{table*}[!t]
    ...
    \begin{tabular}{C{1cm}|C{1.2cm}C{1.2cm}C{1.2cm}C{1.2cm}C{1.2cm}C{1.2cm}C{1.2cm}C{1.2cm}}
        \toprule
        \multirow{2}{*}{\textbf{Seq.}} & \multicolumn{2}{c}{\textbf{Baseline}} & \multicolumn{2}{c}{\textbf{\textbf{Brossard et al.\cite{brossard2020denoising}} }}& \multicolumn{2}{c}{\textbf{Kalibr \cite{rehder2016extending} + Baseline}}& \multicolumn{2}{c}{\textbf{AirIMU} }\\
...
\begin{figure}[H]
	\centering
    \includegraphics[width=0.6\linewidth]{tex/ch5_airimu/figs/FigIntegrate.pdf}
    \caption{
...
\begin{table}[H]
    ...
    \begin{tabular}{C{0.7cm}|C{0.7cm}C{0.6cm}C{0.9cm}C{0.9cm}C{0.6cm}C{0.6cm}}
        \toprule
...
\begin{table}[t]
    ...
    \begin{tabular}{C{0.7cm}|C{1.3cm}C{1.5cm}C{1.3cm}C{1.3cm}}
        \toprule
...
\begin{table}[t]
    ...
    \centering
    \resizebox{0.5\linewidth}{!}{
    \begin{tabular}{C{0.7cm}|C{.8cm}C{.8cm}C{.7cm}C{.9cm}C{.8cm}C{.8cm}}
        \toprule
        ...
        0029 & 0.3435 & 0.393  & - & 6.6598 & \textbf{0.3245} & \textbf{0.3562}\\
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.6\linewidth]{tex/ch5_airimu/figs/FigKITTI.pdf}
    \caption{
...
\begin{table*}[t]
    \caption{Ablation study of the GPS PGO with 1 Hz on the EuRoC dataset with different covariance settings.}
        \label{Tab: Ablation1Hz}
    \centering
    \resizebox{0.6\linewidth}{!}{
    \begin{tabular}{C{3.6cm}|C{2cm}C{2cm}C{2cm}C{2cm}C{2cm}}
        \toprule
        {\textbf{Seq.}} & {{MH02}} & {{MH04}} & {{V103}} & {{V202}}  & {{V101}} \\
         \midrule
        {Raw IMU w/ VinsMono Cov}\raggedright 
        & 0.1493 $\pm$ 0.0044 & 0.1491 $\pm$ 0.0050 & 0.1549 $\pm$ 0.0058          & 0.1542 $\pm$ 0.0051          & 0.1478  $\pm$ 0.0041 \\
        {AirIMU w/ VinsMono Cov}\raggedright 
        & 0.1484 $\pm$ 0.0044          & 0.1486 $\pm$ 0.0049         & 0.1547 $\pm$ 0.0057          & 0.1540  $\pm$ 0.0049    &0.1469 $\pm$ 0.0039\\
        {Raw IMU w/ learned Cov}\raggedright 
        &  0.1184 $\pm$ 0.0041         & 0.1327 $\pm$ 0.0048         & 0.1310 $\pm$ 0.0051          &  0.1569 $\pm$ 0.0078     & 0.1265 $\pm$ 0.0055\\
        {AirIMU w/ learned Cov}\raggedright 
        & \textbf{0.1026 $\pm$ 0.0035} & \textbf{0.1024 $\pm$ 0.0039} & \textbf{0.1039 $\pm$ 0.0028} & \textbf{0.1060 $\pm$ 0.0046} & \textbf{0.1019 $\pm$ 0.0041}\\ 

        \bottomrule
 \multicolumn{4}{c}{Results show the mean and the standard deviation with ATE in meter \si{\meter}.}\\
    \end{tabular} 
    }
\end{table*}
...
\begin{table*}[t]
    \caption{Ablation study of the GPS PGO with 0.1 Hz on the EuRoC dataset with different covariance settings.}
    ...
    \begin{tabular}{C{3.6cm}|C{2cm}C{2cm}C{2cm}C{2cm}C{2cm}}
        ...
        {\textbf{Seq.}} & {{MH02}} & {{MH04}} & {{V103}} & {{V202}}  & {{V101}} \\
         \midrule
        {Raw IMU w/ VinsMono Cov}\raggedright & 2.1454 $\pm$ 0.0150         & 3.6112 $\pm$ 0.0255         & 1.4474 $\pm$ 0.0309          & 1.6840 $\pm$ 0.0165          & 1.4740  $\pm$ 0.0178 \\
        {AirIMU w/ VinsMono Cov}\raggedright & 1.9235 $\pm$ 0.0181          & 0.2955 $\pm$ 0.0270         & 0.3085 $\pm$ 0.0289          & \textbf{0.8681  $\pm$ 0.0214 }   &0.3455 $\pm$ 0.0161\\
        {Raw IMU w/ learned Cov}\raggedright &  2.5088 $\pm$ 0.0368         & 4.3450 $\pm$ 0.0280         & 1.4248 $\pm$ 0.0227          &  2.1213 $\pm$ 0.0184     & 1.1941 $\pm$ 0.0141\\
        {AirIMU w/ learned Cov}\raggedright & \textbf{0.2414 $\pm$ 0.0240} & \textbf{0.2754 $\pm$ 0.0274} & \textbf{0.2905 $\pm$ 0.0216} & 0.8927 $\pm$ 0.0189 & \textbf{0.2948 $\pm$ 0.0144}\\ 
        \bottomrule
 \multicolumn{4}{c}{Results show the mean and the standard deviation with ATE in meter \si{\meter}.}\\
    \end{tabular} 
    }
...
\begin{figure*}[t]
	\centering
    \includegraphics[width=1\linewidth]{tex/ch5_airimu/figs/PGO_Visualize.pdf}
...
\begin{table*}[!t]
    ...
    \centering
    \resizebox{0.6\linewidth}{!}{
    \begin{tabular}{C{1.2cm}|C{0.6cm}C{2cm}C{1.5cm}C{1.5cm}C{1.5cm}C{1.5cm}}
        \toprule
        \multirow{2}{*}{\textbf{Datasets}} & \multirow{2}{*}{\textbf{Robots}} & \multirow{2}{*}{\textbf{Sequences}} &\multirow{2}{*}{\textbf{Baseline}} & \multirow{2}{*}{\textbf{\textbf{Average Bias} }}& \multirow{2}{*}{\parbox{1.3cm}{\centering\textbf{AirIMU}\\ \textbf{(w/o Cov)}}}& \multirow{2}{*}{\parbox{1.1cm}{\centering\textbf{AirIMU}}}\\
        &&&&&&\\
         \hline \noalign{\smallskip}
...
\noindent\textbf{(i) Baseline:} \label{subt:a} This setup serves as our control, integrating the raw IMU data.
It helps to benchmark the other setups.\\
\textbf{(ii) Average Bias:} \label{subt:b} We correct the IMU data by calibrating the biases in the accelerometer and gyroscope from the training dataset. This strategy is widely adopted in traditional IMU calibration algorithms, setting a foundation for comparing with learning-based methods.\\
\textbf{(iii) AirIMU w/o Cov:} \label{subt:c} In this configuration, the AirIMU network is solely trained to correct IMU noise without supervising the covariance explicitly. This setup tests the network's basic capabilities in noise correction.\\
\textbf{(iv) AirIMU with Cov:} \label{subt:d} This advanced setup explicitly supervises the uncertainty in the IMU integration.
...
\begin{figure*}[!t]
	\centering
    \includegraphics[width=1\linewidth]{tex/ch5_airimu/figs/urban_challenge.pdf}
...
\begin{figure*}[!t]
	\centering
    \includegraphics[width=1\linewidth]{tex/ch5_airimu/figs/Fig_nearearth3.pdf}
...
As shown in \fref{Fig: NearEarth}, this dataset encompasses flights over 414 km, featuring average speeds over 150 \si{\km\per\hour} and cruising heights between 200 and 500 meters. This presents a robust testing ground for the AirIMU model's capabilities.
...
\begin{figure}[!t]
	\centering
    \includegraphics[width=0.6\linewidth]{tex/ch5_airimu/figs/TimeAnalysis.pdf}
