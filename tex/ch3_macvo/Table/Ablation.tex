...
\begin{table}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{tex/ch3_macvo/figs/AblationTrajectory.pdf}
        \captionof{figure}{Results of various ablation setups on the H01 of TartanAirv2.}
        \label{fig: Ablation}
    \end{minipage}
\end{table}