...
\centering
    \captionsetup{font=small}
    \caption{Ablation study. Detailed results in \sref{sec:macvo:AdditionalAblation}.}
...
\begin{figure}[H]
    \centering
    \captionsetup{font=small}
    \includegraphics[width=0.5\linewidth]{tex/ch3_macvo/figs/AblationTrajectory.pdf}
