...
\begin{itemize}
    ...
    \item \textbf{Uncertainty-Aware SLAM (MACSLAM)}: Multi-frame SLAM with learned measurement covariance for robust feature selection, loop closure, and estimator consistency
...
This thesis has systematically addressed the six research questions posed in the introduction:
...
\textbf{RQ4-RQ6} (Multi-Sensor Systems): Established uncertainty as the theoretical foundation for optimal sensor fusion (MACVIO), multi-frame SLAM (MACSLAM), and cross-platform adaptation through self-supervised learning (MACIO).
