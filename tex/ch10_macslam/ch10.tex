\chapter{MACSLAM (Proposed): Unified Uncertainty-Aware Multi-Frame Visual-Inertial SLAM} \label{chapter:macslam}
\fancyhead[LO]{\makebox[\textwidth][r]{Chapter 10. MACSLAM (Proposed)}}

\section{Introduction}

This chapter proposes MACSLAM, a unified SLAM framework that combines multi-frame optimization, visual-inertial fusion, and loop closure under a shared uncertainty-aware formulation.
