...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\columnwidth]{tex/ch5_airio/figs/blackbird_trajs/clover.pdf}
    \vspace{0.1em}
    \includegraphics[width=0.8\columnwidth]{tex/ch5_airio/figs/blackbird_trajs/egg.pdf}
    \vspace{0.1em}
    \includegraphics[width=0.8\columnwidth]{tex/ch5_airio/figs/blackbird_trajs/winter.pdf}
    \vspace{0.1em}
    \includegraphics[width=0.8\columnwidth]{tex/ch5_airio/figs/blackbird_trajs/star.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\columnwidth]{tex/ch5_airio/figs/blackbird_trajs/bentDice.pdf}
    \vspace{0.1em}
    \includegraphics[width=0.8\columnwidth]{tex/ch5_airio/figs/blackbird_trajs/oval.pdf}
    \vspace{0.1em}
    \includegraphics[width=0.8\columnwidth]{tex/ch5_airio/figs/blackbird_trajs/sphinx.pdf}
