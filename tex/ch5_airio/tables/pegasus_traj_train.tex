\begin{figure}[h]
    ...
    \begin{subfigure}[b]{0.48\columnwidth}
        ...
        \caption{TRAIN\_1: Distance 516.2$\si{\meter}$, Duration 254.7$\second$, Peak 4.8, Avg. 2.0 $\si{\meter\per\second}$.}
    ...
    \begin{subfigure}[b]{0.48\columnwidth}
        ...
        \caption{TRAIN\_2: Distance 329.0$\si{\meter}$, Duration 165.8$\second$, Peak 4.3, Avg. 2.0 $\si{\meter\per\second}$.}
    ...
    \begin{subfigure}[b]{0.48\columnwidth}
        ...
        \caption{TRAIN\_3: Distance 263.5$\si{\meter}$, Duration 355.5$\second$, Peak 4.6, Avg. 0.7 $\si{\meter\per\second}$.}
    ...
    \begin{subfigure}[b]{0.48\columnwidth}
        ...
        \caption{TRAIN\_4: Distance 452.1$\si{\meter}$, Duration 160.4$\second$, Peak 4.9, Avg. 2.8 $\si{\meter\per\second}$.}
