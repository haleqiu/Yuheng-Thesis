...
\usepackage[utf8]{inputenc} % Ensure UTF-8 characters (—, “”, etc.) work with pdfLaTeX
% Fallback for \IEEEPARstart when not using IEEEtran class
...
\usepackage{tikz}
% Note: xcolor loaded once above; duplicate at line 19 removed
%\usetikzlibrary{external}

\usepackage{amssymb,amsmath,amsfonts,amsthm}
\usepackage{xspace}
\usepackage{bm}
% Prefer nicefrac; fallback to xfrac if unavailable, aliasing \nicefrac
\IfFileExists{nicefrac.sty}{\usepackage{nicefrac}}{\usepackage{xfrac}\let\nicefrac\sfrac}
...
\usepackage{tensor} % for \tensor macro used in ch4
\usepackage{booktabs}
\usepackage{array}
\usepackage{colortbl}
\usepackage{graphicx}
...
% Define icons for monocular and stereo methods in tables
\newcommand{\monoicon}{\raisebox{-0.15\height}{\includegraphics[height=.9em]{tex/ch3_macvo/figs/Icons/MonoCam.pdf}}}
\newcommand{\stereoicon}{\raisebox{-0.15\height}{\includegraphics[height=.9em]{tex/ch3_macvo/figs/Icons/StereoCam.pdf}}}
\newcommand{\loopicon}{\raisebox{-0.15\height}{\includegraphics[height=.9em]{tex/ch3_macvo/figs/Icons/LoopClosure.pdf}}}
\newcommand{\scaleicon}{\raisebox{-0.15\height}{\includegraphics[height=.9em]{tex/ch3_macvo/figs/Icons/ScaleAlign.pdf}}}
...
\usepackage{tabularx}
% Transparent is not needed with pdfLaTeX here; avoid package issues
...
% Custom text commands for thesis parts
\newcommand{\partITitle}{Part I: Visual Perception with Learned Metrics-Aware Covariance}
\newcommand{\partIITitle}{Part II: Inertial Perception with Learned Uncertainty}
\newcommand{\partIIITitle}{Part III: Sensor Fusion and Adaptation Powered by Learned Uncertainty}

% Subtitles without the "Part X:" prefix, for use on divider pages.
\newcommand{\partISubtitle}{Visual Perception with Learned Metrics-Aware Covariance}
\newcommand{\partIISubtitle}{Inertial Perception with Learned Uncertainty}
\newcommand{\partIIISubtitle}{Sensor Fusion and Adaptation Powered by Learned Uncertainty}

% Part divider page (Shibo-style): large "Part N" heading, italic subtitle,
% master three-part overview figure, and a short narrative of the part.
% Usage: \partdivider{I}{\partISubtitle}{Overview narrative text.}
\newcommand{\partdivider}[3]{%
  ...
  \vspace*{1.5cm}%
  \begin{center}
    {\fontsize{34}{40}\selectfont\bfseries Part~#1}\\[0.6cm]
    {\Large\itshape #2}\\[1.6cm]
    \includegraphics[width=0.88\linewidth]{tex/ch1_intro/FigSection.pdf}\\[0.6cm]
  \end{center}
  \vspace{0.6cm}
  \noindent\small #3\normalsize
  \cleardoublepage
